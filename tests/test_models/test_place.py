...
from models.place import Place, __doc__ as place_doc
...
class TestPlaceDocs(TestCase):
    ...
    def test_place_module_docstring(self):
        ...
        self.assertIsNot(place_doc, None,
                         "place.py needs a docstring")
        self.assertTrue(len(place_doc) >= 1,
                        "place.py needs a docstring")
...
class TestPlace(TestCase):
    ...
    def test_to_dict_values(self):
        ...
        self.assertEqual(new_d["created_at"],
                         place.created_at.strftime(t_format))
        self.assertEqual(new_d["updated_at"],
                         place.updated_at.strftime(t_format))
